...
var appresource = {
    Title:'AppGeneralJournalItemsNew',
...
router.get('/', sessionChecker, function(req, res, next) {
    ...
    res.render('AppGeneralJournalItemsNewPage',parameter);
...
router.post('/', sessionChecker, function(req, res, next) {
    ...
    dao.newAppGeneralJournalItems(jsonObj,function(err,rows) {
        if(err==null){
