...
var appresource = {
    Title:'AppArWriteoffVerificationNew',
...
router.get('/', sessionChecker, function(req, res, next) {
    parameter = {
        ...
        acccountNo:'',
        allowanceAccountNo:'',
        referenceNoTobeWriteoff:'',
        }
    }
    res.render('AppArWriteoffVerificationNewPage',parameter);
...
router.post('/', sessionChecker, function(req, res, next) {
    ...
    dao.newAppArWriteoffVerification(jsonObj,function(err,rows) {
        if(err==null){
