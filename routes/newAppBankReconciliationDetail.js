...
var appresource = {
    Title:'AppBankReconciliationDetailNew',
...
router.get('/', sessionChecker, function(req, res, next) {
    parameter = {
        ...
        statusCode:100,
        statusMessage:'',        
        record:{bankReconciliationDetailId:'',
    ...
    res.render('AppBankReconciliationDetailNewPage',parameter);
...
router.post('/', sessionChecker, function(req, res, next) {
    ...
    dao.newAppBankReconciliationDetail(jsonObj,function(err,rows) {
        if(err==null){
