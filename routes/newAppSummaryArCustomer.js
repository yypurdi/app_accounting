...
router.get('/', sessionChecker, function(req, res, next) {
    ...
    res.render('AppSummaryArCustomerNewPage',parameter);
...
router.post('/', sessionChecker, function(req, res, next) {
    ...
    dao.newAppSummaryArCustomer(jsonObj,function(err,rows) {
        if(err==null){
