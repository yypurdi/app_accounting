...
router.get('/', sessionChecker, function(req, res, next) {
    ...
    jsonObj.rowid = 0;
    req.session.previouspath = 'readAppRefCountry?'+req._parsedUrl.query;
    parameter = {
        session: req.session,
        cookies: req.cookies,
        ...
        setTimeout(() => {
            dao.readAppRefCountry(jsonObj,function(err,rows) {
                if(err) res.status(err.code).end();
                    ...
                    if(rows[0]===undefined) res.redirect('/searchAppRefCountry');
                    else{ 
                        jsonObj = rows[0];
                        resolve(jsonObj);
                    }
    ...
    var sendResult = (results) => {
        ...
        res.render('AppRefCountryReadPage',parameter);
    }    
