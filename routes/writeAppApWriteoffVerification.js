...
var appresource = {
    Title:'AppApWriteoffVerificationWrite',
...
router.get('/', sessionChecker, function(req, res, next) {
    ...
    dao.readAppApWriteoffVerification(jsonObj,function(err,rows) {
        ...
        res.render('AppApWriteoffVerificationWritePage',parameter);
...
router.post('/', sessionChecker, function(req, res, next) {
    ...
    dao.writeAppApWriteoffVerification(jsonObj,function(err,rows) {    
        if(err==null){
