...
router.get('/', sessionChecker, function(req, res, next) {
    parameter = {
        ...
        statusCode:100,
        statusMessage:'',        
        record:{recurringBankCrFaId:'',
        recurringBankCashReceiveId:'',
        accountNo:'',
        departmentId:'',
        amount:'',
        jobOrderNo:'',
    ...
    res.render('AppRecurringBankCrFaNewPage',parameter);
...
router.post('/', sessionChecker, function(req, res, next) {
    ...
    dao.newAppRecurringBankCrFa(jsonObj,function(err,rows) {
        if(err==null){
