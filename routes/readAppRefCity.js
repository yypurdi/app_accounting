...
router.get('/', sessionChecker, function(req, res, next) {
    ...
    jsonObj.rowid = 0;
    req.session.previouspath = 'readAppRefCity?'+req._parsedUrl.query;
    parameter = {
        session: req.session,
        cookies: req.cookies,
        ...
        setTimeout(() => {
            dao.readAppRefCity(jsonObj,function(err,rows) {
                if(err) res.status(err.code).end();
                    ...
                    if(rows[0]===undefined) res.redirect('/searchAppRefCity');
                    else{ 
                        jsonObj = rows[0];
                        resolve(jsonObj);
                    }
    ...
    var sendResult = (results) => {
        ...
        res.render('AppRefCityReadPage',parameter);
    }    
